...
import static org.grad.secom.v2.core.interfaces.AccessNotificationServiceInterface.ACCESS_NOTIFICATION_INTERFACE_PATH;
import static org.grad.secom.v2.core.interfaces.AccessServiceInterface.ACCESS_INTERFACE_PATH;
import static org.grad.secom.v2.core.interfaces.AcknowledgementServiceInterface.ACKNOWLEDGMENT_INTERFACE_PATH;
import static org.grad.secom.v2.core.interfaces.CapabilityServiceInterface.CAPABILITY_INTERFACE_PATH;
import static org.grad.secom.v2.core.interfaces.EncryptionKeyNotifyServiceInterface.ENCRYPTION_KEY_NOTIFY_INTERFACE_PATH;
import static org.grad.secom.v2.core.interfaces.EncryptionKeyServiceInterface.ENCRYPTION_KEY_INTERFACE_PATH;
import static org.grad.secom.v2.core.interfaces.GetByLinkServiceInterface.GET_BY_LINK_INTERFACE_PATH;
import static org.grad.secom.v2.core.interfaces.GetServiceInterface.GET_INTERFACE_PATH;
import static org.grad.secom.v2.core.interfaces.GetSummaryServiceInterface.GET_SUMMARY_INTERFACE_PATH;
import static org.grad.secom.v2.core.interfaces.PingServiceInterface.PING_INTERFACE_PATH;
import static org.grad.secom.v2.core.interfaces.RemoveSubscriptionServiceInterface.REMOVE_SUBSCRIPTION_INTERFACE_PATH;
import static org.grad.secom.v2.core.interfaces.SearchServiceServiceInterface.SEARCH_SERVICE_INTERFACE_PATH;
import static org.grad.secom.v2.core.interfaces.SubscriptionNotificationServiceInterface.SUBSCRIPTION_NOTIFICATION_INTERFACE_PATH;
import static org.grad.secom.v2.core.interfaces.SubscriptionServiceInterface.SUBSCRIPTION_INTERFACE_PATH;
import static org.grad.secom.v2.core.interfaces.UploadLinkServiceInterface.UPLOAD_LINK_INTERFACE_PATH;
import static org.grad.secom.v2.core.interfaces.UploadServiceInterface.UPLOAD_INTERFACE_PATH;
