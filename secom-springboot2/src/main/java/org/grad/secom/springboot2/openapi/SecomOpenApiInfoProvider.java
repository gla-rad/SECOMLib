...
package org.grad.secom.springboot2.openapi;
 ...
 */
public interface SecomOpenApiInfoProvider {
    ...
    static OpenAPI defaultOpenAPIInfo() {
        return new OpenAPI().schema("secom", new Schema<>().$schema("openapi.json"))
                .info(new Info().title("SECOM Interfaces")
