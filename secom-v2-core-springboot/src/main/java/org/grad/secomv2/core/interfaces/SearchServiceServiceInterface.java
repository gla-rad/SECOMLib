...
public interface SearchServiceServiceInterface extends GenericSecomInterface {
    ...
    ResponseEntity<SearchResult> searchService(@Valid @RequestBody SearchFilterObject searchFilterObject);
     ...
     */
    static ResponseEntity<Object> handleSearchServiceInterfaceExceptions(Exception ex,
