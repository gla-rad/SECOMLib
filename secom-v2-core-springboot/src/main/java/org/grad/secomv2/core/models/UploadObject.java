...
/**
 * The SECOM Upload Object Class
 *
 * @author Nikolaos Vastardis (email: Nikolaos.Vastardis@gla-rad.org)
 */
public class UploadObject implements EnvelopeSignatureBearer {

    // Class Variables
    @NotNull
    private EnvelopeUploadObject envelope;
    @NotNull
    @Schema(description = "The signature ot the EnvelopeUploadObject in HEX format without whitespace or linebreaks")
     ...
     */
    @Override
    public EnvelopeUploadObject getEnvelope() {
        return envelope;
    }
     ...
     */
    public void setEnvelope(EnvelopeUploadObject envelope) {
