...
public interface EncryptionKeyRequestServiceInterface extends GenericSecomInterface {
     ...
     */
    @PostMapping(path = ENCRYPTION_KEY_REQUEST_INTERFACE_PATH,
                consumes = { MediaType.APPLICATION_JSON_VALUE },
                produces = { MediaType.APPLICATION_JSON_VALUE })
    ResponseEntity<EncryptionKeyResponseObject> encryptionKeyRequest(@Valid @RequestBody EncryptionKeyRequestObject encryptionKeyRequestObject);
     ...
     */
    static ResponseEntity<Object> handleEncryptionKeyRequestInterfaceExceptions(Exception ex,
