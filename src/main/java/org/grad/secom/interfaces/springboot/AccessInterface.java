...
public interface AccessInterface extends GenericInterface {
     ...
     */
    public static final String ACCESS_INTERFACE_PATH = "/v1/access";
     ...
     */
    @PostMapping(ACCESS_INTERFACE_PATH)
    ResponseEntity<AccessResponseObject> requestAccess(@RequestBody @Valid AccessRequestObject accessRequestObject);
