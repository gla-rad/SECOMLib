...
/**
 * The SECOM Encryption Key Type Enum.
 *
...
public enum EncryptionKeyTypeEnum {
     ...
     */
    EncryptionKeyTypeEnum(final int newValue) {
        value = newValue;
    }
     ...
     */
    public static EncryptionKeyTypeEnum fromValue(int value) {
        return Arrays.stream(EncryptionKeyTypeEnum.values())
