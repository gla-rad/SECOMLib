...
class UploadLinkResponseObjectTest {

    // Class Variables
    private UploadLinkResponseObject obj;
    ...
    void setup() {
        ...
        this.obj = new UploadLinkResponseObject();
    ...
    void testJson() throws JsonProcessingException {
        ...
        UploadLinkResponseObject result = this.mapper.readValue(jsonString, UploadLinkResponseObject.class);
