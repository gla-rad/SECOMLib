...
public interface EncryptionKeyRequestServiceInterface extends GenericSecomInterface {
     ...
     */
    String ENCRYPTION_KEY_INTERFACE_PATH = SECOM_VERSION + "/" + SECOM_VERSION + "/encryptionkey/request";
    ...
    EncryptionKeyResponseObject encryptionKeyRequest(@Valid EncryptionKeyRequestObject encryptionKeyRequestObject);
