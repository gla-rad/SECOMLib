...
class ResponseSearchObjectTest {
    ...
    private ServiceInstanceObject serviceInstanceObject;
    ...
    void setup() throws URISyntaxException {
        ...
        this.serviceInstanceObject.setEndpointUri("http://localhost");
        ...
        this.obj.setSearchServiceResult(Collections.singletonList(this.serviceInstanceObject));
    }
